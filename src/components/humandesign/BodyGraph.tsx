...
const BodyGraph = ({ 
  ...
  const renderHumanSilhouette = () => (
    <g opacity="0.08">
      ...
      <ellipse cx="250" cy="55" rx="35" ry="35" fill="#888" /> {/* Cabeça */}
      <path 
        d="M180,100 C160,150 140,200 130,280 L120,450 C120,480 150,520 180,550 L200,570 
           L250,580 L300,570 L320,550 C350,520 380,480 380,450 L370,280 
           C360,200 340,150 320,100 Z" 
        fill="#888"
      />
    </g>
  );
