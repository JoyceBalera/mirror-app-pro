...
const BodyGraph = ({ 
  ...
  const renderHumanSilhouette = () => (
    <g opacity="0.12" fill="#8B7355">
      {/* Cabeça */}
      <ellipse cx="250" cy="38" rx="30" ry="36" />
      
      {/* Pescoço */}
      <rect x="238" y="72" width="24" height="22" rx="2" />
      
      {/* Corpo principal com braços e pernas */}
      <path d="
        M250,94
        
        C220,94 195,98 175,105
        L165,110
        C145,118 125,135 115,160
        L100,200
        C90,230 85,265 85,300
        L82,340
        C80,365 78,390 80,410
        L85,450
        C88,475 95,500 105,520
        L115,540
        C120,552 128,565 140,578
        L155,595
        L170,610
        C175,620 180,635 185,655
        L190,690
        C192,710 195,730 200,745
        L205,760
        L220,765
        L230,760
        L235,745
        C238,720 240,695 240,670
        L238,640
        C237,615 235,590 232,565
        L230,545
        C235,540 242,538 250,538
        C258,538 265,540 270,545
        L268,565
        C265,590 263,615 262,640
        L260,670
        C260,695 262,720 265,745
        L270,760
        L280,765
        L295,760
        L300,745
        C305,730 308,710 310,690
        L315,655
        C320,635 325,620 330,610
        L345,595
        L360,578
        C372,565 380,552 385,540
        L395,520
        C405,500 412,475 415,450
        L420,410
        C422,390 420,365 418,340
        L415,300
        C415,265 410,230 400,200
        L385,160
        C375,135 355,118 335,110
        L325,105
        C305,98 280,94 250,94
        Z
      " />
    </g>
  );
